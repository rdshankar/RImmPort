...
*****
# Introduction
ImmPort study data is available for download in two formats currently: MySQL format, and TSV (Tab) format. The RImmPort workflow is as follows: 
