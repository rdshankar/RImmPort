...
# subject_visits_column_names <- c("STUDYID", "DOMAIN", "USUBJID","VISITNUM", "VISIT", 
#                                 "VISITDY", "SVSTDTC", "SVENDTC", "SVSTDY", "SVENDY", "SVUPDES")

subject_visits_column_names <- c("study_id", "domain", "subject_id","visit_number", "visit_name", "planned_study_day_of_visit", 
